d3.radialMenu = function ()
{
    ...
    control.show = function (_)
    {
        ...
        //Add BG info -------------------------------
        dataJoin.select(".menu-segment-info")
            .transition()
            .duration(animationDuration)
            .attrTween("d", function (a)
            {
        ...
        //AFTER INFO ADDED ____----____----____----____----____----____----____----____----____
        //ADD OBJECTS FROM BTM TO TOP  ____----____----____----____----____----____----____----
